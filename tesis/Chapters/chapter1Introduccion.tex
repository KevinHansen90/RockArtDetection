...
\begin{itemize}
    ...
    Denotemos
    \[
      C_k = \{\text{motivos asignados al $k$-ésimo \emph{cluster}}\},\qquad
    ...
    \]
    La métrica mide la fracción de motivos correctamente agrupados según la clase dominante en cada \emph{cluster},
    ...
    Sean \(\mathcal{C}=\{C_1,\dots,C_K\}\) la partición obtenida por el algoritmo y
