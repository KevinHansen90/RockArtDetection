...
\end{figure}
\footnotetext{Durante las primeras iteraciones se incrementa gradualmente la
tasa de aprendizaje para evitar inestabilidades numéricas.
Este \emph{warm-up} provoca picos en la \texttt{loss} antes de asentarse.}
